            ...
            <div class="row">
              <div class="col">
                <div class="clock-container">
                  <i class="fa-regular fa-clock color-icons-contact"></i>
                  <p class="text-clock-container">9:00 a 19:00</p>
                </div>
                <p class="text-clock-margin">Horario de atención</p>
                <p class="text-clock-margin">Lunes a Jueves</p>
              </div>
              <div class="col">
                <div class="clock-container">
                  <i class="fa-regular fa-clock color-icons-contact"></i>
                  <p class="text-clock-container">9:00 a 15:00</p>
                </div>
                <p class="text-clock-margin">Horario de atención</p>
                <p class="text-clock-margin">Viernes</p>
              </div>
            </div>
            <div class="row">
